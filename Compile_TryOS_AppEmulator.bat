...
copy ".\TouchTest\bin\Debug\Settings\ShellName.setting" ".\TouchTest\bin\Debug\TryOS_Build\Settings\"
...
copy ".\TouchTest\bin\Debug\TouchTest.exe" ".\TouchTest\bin\Debug\TryOS_Build\TryOS-AppEmulator.exe"
